...
const ruQuestions = [
  ...
  },
  {
    ...
    type: "multiple_choice",
    points: 1,
    text: "Задание №12. Определите вид сказуемого: «Он хотел научиться танцевать».",
...
const maQuestions = [
  { id: "ma_9_q1", type: "multiple_choice", points: 1, text: "1. Выполните деление: (2/3) : (3/2)", options: ["А) 4/9", "Б) 9/4", "В) 2/3", "Г) 3/2"] },
  ...
  { id: "ma_9_q3", type: "multiple_choice", points: 1, text: "3. Найдите значение выражения: -7 · (-2,4)", options: ["А) 17", "Б) 0,8", "В) 16,8", "Г) 4"] },
  { id: "ma_9_q4", type: "multiple_choice", points: 1, text: "4. Выберите неверное равенство:", options: ["А) √16 = 4", "Б) √0,04 = 0,2", "В) 7 - √25 = 2", "Г) √(-9)² = -9"] },
  { id: "ma_9_q5", type: "multiple_choice", points: 1, text: "5. Найдите корни уравнения х² + 7х – 18 = 0:", options: ["А) –2 и 9", "Б) –9 и 2", "В) корней нет", "Г) 2 и 9"] },
