...
const ruQuestions = [
  ...
  },
  {
    ...
    type: "multiple_choice",
    points: 1,
    text: "Задание №10. Укажите предложение с ошибкой в употреблении числительного:",
    options: [
...
const maQuestions = [
  ...
  { id: "ma_8_q9", type: "multiple_choice", points: 1, text: "9. Треугольник, с какими сторонами можно построить?", options: ["А) 2; 2; 4", "B) 8; 11; 2", "C) 11; 6; 6", "D) 18; 9; 8", "E) 3; 2; 6"] },
  ...
  { id: "ma_8_q12", type: "multiple_choice", points: 1, text: "12. Решите неравенство: 4у + 4 < y - 5", options: ["А) (-∞; -3)", "В) (- ∞; 3)", "С) (-∞; -9)", "D) (3; + ∞)", "Е) (-3; + ∞)"] },
  ...
  { id: "ma_8_q15", type: "multiple_choice", points: 1, text: "15. Представьте в виде произведения: х(a – b) + y(b – a)", options: ["A) (a – b)(x – y)", "B) (b – a)(x – y)", "C) – (x + y)(a + b)", "D) (x + y)(b – a)", "E) (a – b)(x + y)"] },
  { 
    id: "ma_8_q16", 
    type: "multiple_choice", 
    points: 1, 
    text: "16. Найдите сумму трех внешних углов треугольника, взятых по одному при каждой вершине (∠1 + ∠2 + ∠3):", 
    options: ["A) 90°", "B) 150°", "C) 180°", "D) 360°", "E) 200°"] 
  },
  ...
  { id: "ma_8_q18", type: "multiple_choice", points: 1, text: "18. В упаковке из 20 шариков 12 красные, а остальные — зеленые. Какова вероятность того, что наугад будет извлечен зеленый шарик?", options: ["A) 3/5", "B) 2/5", "C) 1/12", "D) 1/20", "E) 1/8"] },
  { id: "ma_8_q19", type: "multiple_choice", points: 1, text: "19. Выполните возведение в степень: (2a²b)³", options: ["A) 2a⁶b³", "B) 8a⁶b³", "C) 2b", "D) 8b³", "E) 16a⁴b³"] },
  ...
  { id: "ma_8_q22", type: "multiple_choice", points: 1, text: "22. Самир положил в банк 12 000 сом под 10% простых годовых. Какая сумма будет на его счету через 3 года?", options: ["A) 12 360", "B) 13 600", "C) 15 600", "D) 12 120", "E) 16 000"] }
];
...
const russianKeys = {
  ...
  "ru_8_q5": { ans: "1", pts: 1, topic: "Орфография: НЕ с разными частями речи" },
  "ru_8_q6": { ans: "3", pts: 1, topic: "Орфография: Н и НН" },
  "ru_8_q7": { ans: "1", pts: 1, topic: "Орфография: чередующиеся гласные" },
  "ru_8_q8": { ans: "3", pts: 1, topic: "Фразеология и значения" },
  "ru_8_q9": { ans: "2", pts: 1, topic: "Орфография: приставки ПРЕ/ПРИ" },
  "ru_8_q10": { ans: "4", pts: 1, topic: "Морфология: числительные" }, // ИСПРАВЛЕНО НА 4
  "ru_8_q11": { ans: "4", pts: 1, topic: "Орфография: дефисное написание" },
  "ru_8_q12": { ans: "часть речи, член предложения, часть речи, член предложения, часть речи", pts: 1, topic: "Морфология и синтаксис" },
  "ru_8_q13": { ans: "1", pts: 1, topic: "Пунктуация в сложном предложении" }
};
...
const mathKeys = {
  ...
  "ma_8_q5": { ans: "E", pts: 1, topic: "Разложение на множители" }, // ИСПРАВЛЕНО НА E
  ...
  "ma_8_q16": { ans: "D", pts: 1, topic: "Сумма внешних углов" }, // ИСПРАВЛЕНО НА D
