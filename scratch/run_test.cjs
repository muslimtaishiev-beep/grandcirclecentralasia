const { calculateScores, ANSWER_KEYS } = require('./test_calc_runner.cjs');
...
const payload = {
  ...
  "logic_4": "{\"Олег\":\"Певец\",\"Коля\":\"Скрипач\",\"Ваня\":\"Пианист\"}",
  "logic_5": "Уменьшилась на 1%",
  "logic_6": "125",
  "logic_7": "12",
  "logic_8": "46"
};

const result = calculateScores("9", payload);
