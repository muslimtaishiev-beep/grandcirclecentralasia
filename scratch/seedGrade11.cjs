...
const ruQuestions = [
  ...
  },
  {
    ...
    options: [
      ...
      "5) Никто (не) дерзал отказываться от его приглашения."
    ]
  },
  {
    id: "ru_11_q8",
...
const maQuestions = [
  ...
  { id: "ma_11_q7", type: "number_input", points: 1, text: "B1. Точка движется по координатной прямой согласно закону X(t) = 3 + 2t + t², где X(t) — координата точки в момент времени t. В какой момент времени скорость точки будет равна 5?" },
...
const russianKeys = {
  ...
  "ru_11_q5": { ans: "5", pts: 1, topic: "Правописание приставок и Ы/И" }, // ИСПРАВЛЕНО НА 5
  ...
  "ru_11_q10": { ans: "2", pts: 1, topic: "Пунктуация: деепричастные и причастные обороты" } // ИСПРАВЛЕНО НА 2
};
