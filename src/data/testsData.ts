    ...
    russian: [
      ...
      },
      {
        ...
        options: [
          ...
          "4) водор..сли – в корне с чередованием перед С пишется буква О"
        ]
      },
      {
        id: "ru_7_q5",
      ...
      },
      {
        ...
        options: [
          ...
          "3) Кружатся падают с берёз лёгкие жёлтые листья.",
    ...
    math: [
      {
        ...
        type: "multiple_choice",
        points: 1,
        text: "1. Какое из следующих чисел самое большое?",
        options: ["1) 0,0052", "2) 0,0794", "3) 0,15", "4) 0,106"]
      },
      {
        id: "ma_7_q2",
        type: "multiple_choice",
        points: 1,
        text: "2. Нацело на 18 делится число:",
        options: ["1) 364", "2) 328", "3) 339", "4) 342"]
      },
      {
        id: "ma_7_q3",
        type: "multiple_choice",
        points: 1,
        text: "3. Сократите:",
        options: ["1) 1/2", "2) 2/3", "3) 3/4", "4) 4/5"]
      },
      {
        id: "ma_7_q4",
        type: "multiple_choice",
        points: 1,
        text: "4. Брусок длиной 5 м распилили на части по 5/8 м в каждой. Таких частей получилось:",
        options: ["1) 8", "2) 6", "3) 7", "4) 9"]
      },
      {
        id: "ma_7_q5",
        type: "multiple_choice",
        points: 1,
        text: "5. Длина прямоугольника равна 22 см, а ширина составляет 3/11 его длины. Найдите периметр прямоугольника.",
        options: ["1) 26 см", "2) 46 см", "3) 52 см", "4) 56 см"]
      },
      {
        id: "ma_7_q6",
        type: "multiple_choice",
        points: 1,
        text: "6. Какая из координатных точек расположена на координатной прямой левее других?",
        options: ["1) А (-7)", "2) В (10)", "3) С (-11)", "4) Д (4)"]
      },
      {
        id: "ma_7_q7",
        type: "multiple_choice",
        points: 1,
        text: "7. Решите уравнение: 2х = - 6,2",
        options: ["1) 6,2", "2) - 6,2", "3) - 3,1", "4) 3,1"]
      },
      {
        id: "ma_7_q8",
        type: "multiple_choice",
        points: 1,
        text: "8. Выполните сложение: - 6,4 + (- 12)",
        options: ["1) - 5,6", "2) – 18,4", "3) – 6,6", "4) 18,4"]
      },
      {
        id: "ma_7_q9",
        type: "multiple_choice",
        points: 1,
        text: "9. У какого из данных чисел наименьший модуль?",
        options: ["1) - 21,39", "2) – 21,4", "3) 21,305", "4) 25,5"]
      },
      {
        id: "ma_7_q10",
        type: "multiple_choice",
        points: 1,
        text: "10. Решите уравнение: х – 8,31 = - 5,76",
        options: ["1) 2,55", "2) – 13,07", "3) – 10,52", "4) 14,07"]
      },
      {
        id: "ma_7_q11",
        type: "multiple_choice",
        points: 1,
        text: "11. Выполните вычитание: 3 - 5",
        options: ["1) - 2", "2) - 1", "3) - 8", "4) 8"]
      },
      {
        id: "ma_7_q12",
        type: "multiple_choice",
        points: 1,
        text: "12. Округлите число 37,285 до десятых:",
        options: ["1) 37,3", "2) 37,2", "3) 37,29", "4) 37"]
      },
      {
        id: "ma_7_q13",
        type: "multiple_choice",
        points: 1,
        text: "13. Вычислите: -8 + 11 – 6 - 9",
      ...
      },
      {
        ...
        type: "multiple_choice",
        points: 1,
        text: "14. В сберегательном банке денежный вклад за один год увеличивается на 5%. Если вкладчик положил 200 000 сом, то через год у него будет:",
        options: ["1) 10 000 сом.", "2) 20 000 сом.", "3) 210 000 сом.", "4) 202 000 сом."]
      },
      {
        id: "ma_7_q15",
        type: "multiple_choice",
        points: 1,
        text: "15. Найдите значение выражения 18,18a – 28,18a + 10 при a = - 9",
        options: ["1) - 100", "2) 100", "3) 19", "4) 80"]
      },
      {
        id: "ma_7_q16",
        type: "multiple_choice",
        points: 1,
        text: "16. Вычислите: - 2,5 ∙ (- 1,6) + 41,6 : (-40)",
        options: ["1) 3,6", "2) – 4,04", "3) 4,04", "4) 2,96."]
      },
      {
        id: "ma_7_q17",
        type: "multiple_choice",
        points: 1,
        text: "17. Найдите сумму корней уравнений: 12,4 - х = 2,6 и х : 1,9 = - 3",
        options: ["1) 9,3", "2) 4,1", "3) – 15,5", "4) нет правильного ответа"]
      },
      {
        id: "ma_7_q18",
        type: "multiple_choice",
        points: 1,
        text: "18. В таблице приведены оценки по математике у 25 учеников: «5» - 6 учеников, «4» - 9 учеников, «3» - 7 учеников, «2» - 3 ученика. Найдите моду и размах этих данных.",
        options: ["1) мода = 9, размах = 6", "2) мода = 5, размах = 3", "3) мода = 4, размах = 2"]
      },
      {
        id: "ma_7_q19",
        type: "multiple_choice",
        points: 1,
        text: "19. В классе 24 ученика. На кружки по рисованию ходят 9 человек, на кружок по шахматам – 7 человек, на оба кружка – 3 человека. Сколько учеников не посещают ни один из этих кружков?",
        options: ["1) 5 учеников", "2) 8 учеников", "3) 11 учеников", "4) определить нельзя."]
      },
      {
        id: "ma_7_q20",
        type: "multiple_choice",
        points: 1,
        text: "20. На прямой даны три точки А, В, С. Какова длина отрезка АС, если расстояние между точками А и В равно 23 см, а расстояние между точками В и С равно 3дм?",
        options: ["1) 7 см", "2) 27 дм", "3) 53 см", "4) 7 см или 53 см."]
      }
    ],
      ...
      },
{
      ...
      },
      {
        ...
        clickableSegments: [
          ...
          { text: "ым стеклом жила своей утре" },
          { text: " (2) ", id: "2", isTarget: true },
          { text: "ей жизнью обыкнове" },
          { text: " (3) ", id: "3", isTarget: true },
          { text: "ая городская асфальтирова" },
          { text: " (4) ", id: "4", isTarget: true },
          { text: "ая улица, по которой мчались переполне" },
          { text: " (5) ", id: "5", isTarget: true },
          { text: "ые маршрутные такси и гружё" },
      ...
      },
      {
        ...
        clickableSegments: [
          { text: "Привлечённые запахом" },
          { text: " (1) ", id: "1", isTarget: true },
          { text: "цветущей в парке" },
          { text: " (2) ", id: "2", isTarget: true },
          { text: "акации" },
          { text: " (3) ", id: "3", isTarget: true },
          { text: "мы остановились" },
          { text: " (4) ", id: "4", isTarget: true },
          { text: "наслаждаясь ароматом." }
        ]
      }
    ],
            math: [
