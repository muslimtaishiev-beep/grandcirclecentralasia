 ...
 *
 * Правило совместимости: значения по умолчанию РАВНЫ прежним захардкоженным
 * текстам. Организация без workspaceConfig (Академия будущих лидеров и все
 * существующие) видит ровно то же, что и раньше, — конфиг меняет вид только
 * там, где владелец его сохранил.
 */
...
export const DEFAULT_WORKSPACE_CONFIG: Required<Omit<WorkspaceConfig, "setupCompleted" | "activityType">> & { activityType: string } = {
  ...
  dashboardTitle: "Панель Управления Академией",
  dashboardSubtitle:
